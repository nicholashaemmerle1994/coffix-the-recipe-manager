  ...
  return (
    <>
      ...
      <div className="sm:flex sm:flex-wrap justify-center  mb-16 sm:mb-0 max-w-4xl">
        <div className="card card-side  shadow-xl m-2.5 bg-transparent flex flex-col max-w-lg text-warning sm:flex sm:flex-row sm:flex-wrap mb-16 sm:mb-0">
          <div className=" sm:flex sm:flex-col w-full">
            <figure className="rounded-t-xl rounded-b-none sm:h-5/6 sm:w-full">
              <Image
            ...
            <div className="m-2 hidden sm:flex justify-center">
              <Link
                className="flex flex-row justify-center items-center "
                href={`/profile/${props.post[0].userName}`}
              >
                <p className="text-xs font-light text-warning text-opacity-50 mr-6">
                  Created By:{' '}
                </p>
                <Image
          ...
          <div className="card-body pt-0 pb-0">
            <h2 className="text-2xl font-bold text-warning">How to: </h2>
